...
const sourceRequirements = [
  ...
  ['src/platform/app-router.tsx', 'window.location.replace(`/login?return_to=${returnTo}`)'],
  ['src/platform/pages/AuthPages.tsx', 'RESET_TOKEN_REQUIRED'],
  ['src/features/auth/LoginPage.tsx', "auth_stage === 'pending_2fa'"],
  ...
  ['src/features/security/SecurityPage.tsx', '成功したように見せる空POSTは行いません。'],
  ...
  ['src/features/composer/NativeComposerPage.tsx', 'normalizeResult'],
  ...
  ['src/features/composer/NativeComposerPage.tsx', "'Idempotency-Key': requestId"],
  ['src/features/composer/NativeComposerPage.tsx', 'PURPOSE_CHOICES'],
  ['src/features/composer/NativeComposerPage.tsx', 'setPurpose((current) => current === item.key ? \'auto\' : item.key)'],
  ['src/features/settings/OptionSettingsPage.tsx', 'optionToggleNote'],
