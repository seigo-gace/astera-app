...
export const canonicalRoutes: readonly CanonicalRoute[] = [
  ...
  { id: 'settings-data-privacy', pattern: '/app/settings/data-privacy', title: 'プライバシー・データ', group: 'settings', access: 'authenticated', nav: 'settings' },
  { id: 'settings-notifications', pattern: '/app/settings/notifications', title: '通知', group: 'settings', access: 'authenticated', nav: 'settings' },
  { id: 'settings-legal-support', pattern: '/app/settings/legal-support', title: '法務・サポート', group: 'settings', access: 'authenticated', nav: 'settings' },
  ...
  { id: 'developer', pattern: '/app/developer', title: '開発者モード', group: 'developer', access: 'authenticated', nav: 'developer' },
