...
const workspaceRoutes = new Set(['result-detail', 'settings', 'settings-options', 'settings-language', 'settings-templates', 'settings-storage-destinations', 'settings-astera-storage', 'settings-data-privacy', 'settings-notifications']);
