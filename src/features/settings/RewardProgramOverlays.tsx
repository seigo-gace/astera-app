...
import { ApiError, apiRequest, asArray, asRecord, recordText, textValue } from '../../platform/api-client';
...
function CouponOverlay({ onClose }: { onClose: () => void }) {
  ...
  const loadHistory = useCallback(async () => {
    try { setHistory(asArray(await apiRequest('/api/coupons/redemptions'), ['redemptions','items'])); }
