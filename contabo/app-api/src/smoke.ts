...
try{
 ...
 console.log(JSON.stringify({event:'contabo_runtime_smoke_passed',process_calls:processCalls,private_result_persisted:false,postgres_required:false,restart_loss_fail_closed:true}));
